...
class Recipe_Model extends Model
{
    ...
    private function send_email($id, $text)
    {
        ...
        <h3 style="color: #585858;">User ' . $username . ' posted a new comment under your recipe:</h3><div style="text-align: left;padding: 1vw;margin-bottom: 1vw;border: 1px solid #cccccc;border-radius: 10px;">
